...
exports.removeCart = exports.addCart = void 0;
...
var removeCart = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(iditem) {
...
exports.getBillOrderToSetTrack = void 0;
...
var getBillOrderToSetTrack = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(IDbillorder, socket) {
    var markup, orders, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 4:
            res = _context.sent;
            orders = res.data; // markup = generateMarkup(res.data);

            markup = generateMarkup(orders);
            IDbillorder.html(markup); // Socket
...
var updateStatus = function updateStatus(order, statuses, time) {
  ...
  statuses.forEach(function (status) {
    ...
    if (status.dataset.status === order.status) {
      stepCompleted = false;
      time.innerText = (0, _moment.default)(order.updatedAt).format('L, LTS');
...
},{"moment":"../../node_modules/moment/moment.js"}],"../../node_modules/moment/locale/vi.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
var _updatestatus = require("./updatestatus.js");
...
if (addtocart) {
  addtocart.each(function (index, btnElement) {
    btnElement.addEventListener('click', function (e) {
      ...
      (0, _cart.addCart)(getPizzaAdded, getCartCount);
...
var getPizzaRemove = document.querySelectorAll('#removeCart');

if (getPizzaRemove) {
  getPizzaRemove.forEach(function (el) {
    el.addEventListener('click', function () {
      var dataIDItem = el.dataset.iditem;
      (0, _cart.removeCart)(dataIDItem);
    });
  });
}
/* *********************************************************** */
...
var hiddenBillOrder = document.querySelector('#hiddenBillOrderInput');
var order = hiddenBillOrder ? hiddenBillOrder.value : null;
order = JSON.parse(order);

if (hiddenBillOrder) {
  (0, _updatestatus.updateStatus)(order, statuses, time);
...
var getIDbillorder = $('#billorderTableBody');
var adminAreaPath = window.location.pathname;

if (adminAreaPath.includes('admin')) {
  console.log(adminAreaPath);
  (0, _admin.getBillOrderToSetTrack)(getIDbillorder, socket);
...
socket.on('statusUpdated', function (data) {
  ...
  (0, _updatestatus.updateStatus)(updatedOrder, statuses, time);
});
/* *********************************************************** */
//Remove alert message after specify time

var alertMes = $('#success-alert');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "12158" + '/');
